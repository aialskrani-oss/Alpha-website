...
app.get("/api/healthz", (_req: any, res: any) => res.json({ status: "ok" }));
...
app.get("/api/sections", async (_req: any, res: any) => {
  try {
...
app.post("/api/sections", async (req: any, res: any) => {
  try {
...
app.get("/api/sections/by-slug/:slug", async (req: any, res: any) => {
  try {
...
app.get("/api/sections/:id", async (req: any, res: any) => {
  try {
...
app.put("/api/sections/:id", async (req: any, res: any) => {
  try {
...
app.delete("/api/sections/:id", async (req: any, res: any) => {
  try {
...
app.get("/api/platforms", async (req: any, res: any) => {
  try {
...
app.post("/api/platforms", async (req: any, res: any) => {
  try {
...
app.get("/api/platforms/:id", async (req: any, res: any) => {
  try {
...
app.put("/api/platforms/:id", async (req: any, res: any) => {
  try {
...
app.delete("/api/platforms/:id", async (req: any, res: any) => {
  try {
...
app.get("/api/news", async (req: any, res: any) => {
  try {
    ...
    if (req.query.published === "true") rows = rows.filter((n: any) => n.isPublished);
...
app.get("/api/news/by-slug/:slug", async (req: any, res: any) => {
  try {
...
app.put("/api/news/:id", async (req: any, res: any) => {
  try {
...
app.delete("/api/news/:id", async (req: any, res: any) => {
  try {
...
app.get("/api/advertisements", async (req: any, res: any) => {
  try {
    let rows = await db.select().from(advertisementsTable).orderBy(asc(advertisementsTable.order));
    if (req.query.active === "true") rows = rows.filter((a: any) => a.isActive);
    res.json(rows);
  } catch (e) { res.status(500).json({ error: String(e) }); }
});

app.post("/api/advertisements", async (req: any, res: any) => {
  try {
...
app.put("/api/advertisements/:id", async (req: any, res: any) => {
  try {
...
app.delete("/api/advertisements/:id", async (req: any, res: any) => {
  try {
...
app.get("/api/stats", async (_req: any, res: any) => {
  try {
    ...
    res.json({
      ...
      platformsBySection: sections.map((s: any) => ({
        sectionId: s.id,
        sectionName: s.nameAr || s.name,
        count: platforms.filter((p: any) => p.sectionId === s.id).length,
      })),
    });
  } catch (e) { res.status(500).json({ error: String(e) }); }
});
